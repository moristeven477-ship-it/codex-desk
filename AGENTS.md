...
- CLI runtime settings take priority. Desk may override them only after an explicit change in its UI. Inherit sandbox, approval policy, model, reasoning, service tier, and collaboration settings on ordinary sends.
